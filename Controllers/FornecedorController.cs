...
namespace JPConsultoria.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cnpj,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cnpj,Email")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
